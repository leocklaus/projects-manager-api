...
@Component
public class SubTaskCreatedNotificationStrategy implements NotificationStrategy {
    ...
    public SubTaskCreatedNotificationStrategy(){}
    ...
    public void sendNotification(User actor, UUID objectId) {
        ...
        notificationService.postNotification(actor, members, NotificationType.NEW_SUBTASK_CREATED);
    }
}
