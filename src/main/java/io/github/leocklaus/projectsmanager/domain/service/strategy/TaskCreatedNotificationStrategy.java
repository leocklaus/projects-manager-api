...
@Component
public class TaskCreatedNotificationStrategy implements NotificationStrategy {
    ...
    public TaskCreatedNotificationStrategy(){}
    ...
    public void sendNotification(User actor, UUID objectId) {
        ...
        notificationService.postNotification(actor, members, NotificationType.NEW_TASK_CREATED);
    }
}
