...
@Component
public class ProjectCompletedNotificationStrategy implements NotificationStrategy {
    ...
    public ProjectCompletedNotificationStrategy(){}
    ...
    public void sendNotification(User actor, UUID objectId) {
        ...
        notificationService.postNotification(actor, members, NotificationType.PROJECT_COMPLETED);
    }
}
